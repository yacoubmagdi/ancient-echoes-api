...
const id = '1574b449-f602-4f4c-8489-f56af6225839';
const path = `Pharaoh/${id}_v2_${Date.now()}.png`;
const up = await sb.storage.from('personas').upload(path, readFileSync('/tmp/khaemhat_v2.png'), { contentType:'image/png', upsert:true });

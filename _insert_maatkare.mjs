...
const { error } = await sb.from('personas').insert({
  ...
  role: 'priestess',
  gender: 'female',
  description: 'ماعت كا رع موت إم حات، زوجة الإله آمون والكاهنة الكبرى في طيبة خلال الأسرة الحادية والعشرين (حوالي 1050 ق.م). ابنة الفرعون والكاهن الأكبر بينجم الأول، وحفيدة حريحور. حملت أعلى لقب ديني للنساء في مصر القديمة، ودُفنت في الدير البحري، ووُجدت موميائها ضمن مخبأ الموميات الملكية DB320.',
